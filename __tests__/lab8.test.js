describe('Basic user flow for Website', () => {
    ...
    it('Clicking the "Add to Cart" button should change button text', async() => {
        ...
        let bt = await shadow.$('button');

        await bt.click();

        let txt = await bt.getProperty('innerText');
        let value = await txt.jsonValue();
    ...
    it('Checking number of items in cart on screen', async() => {
        ...
        let t = await cart.getProperty('innerText');
        let it = await t.jsonValue();
        expect(it).toBe("20");
        // TODO - Step 3
    ...
    it('Checking number of items in cart on screen after reload', async() => {
        ...
        let cart = await page.$("#cart-count");
        let tx = await cart.getProperty('innerText');
        let it = await tx.jsonValue();
        expect(it).toBe("20");
        // TODO - Step 4
    ...
    it('Checking the localStorage to make sure cart is correct', async() => {
        const ls = await page.evaluate(() => localStorage.getItem("cart"));
